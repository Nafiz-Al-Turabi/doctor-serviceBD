            ...
            <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div>
                    <div className="bg-white relative shadow-lg hover:shadow-xl transition duration-500 rounded-lg">
                        ...
                        <div className="py-6 px-8 rounded-lg bg-white">
                            <h1 className="text-gray-700 font-bold text-xl mb-3 hover:text-gray-900 hover:cursor-pointer">Anesthesiology Specialist.</h1>
                ...
                <div>
                    <div className="bg-white relative shadow-lg hover:shadow-xl transition duration-500 rounded-lg">
                        ...
                        <div className="py-6 px-8 rounded-lg bg-white">
                            <h1 className="text-gray-700 font-bold text-xl mb-3 hover:text-gray-900 hover:cursor-pointer">Cardiology Specialist.</h1>
                            <p className="text-gray-700 text-justify tracking-wide">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eum, labore. Ea debitis beatae sequi deleniti.</p>
                            <button className="mt-6 py-2 px-4 primary-bg text-white font-bold rounded-lg shadow-md hover:shadow-lg transition duration-300">More info</button>
                        </div>
                    </div>
                ...
                <div>
                    <div className="bg-white relative shadow-lg hover:shadow-xl transition duration-500 rounded-lg">
                        ...
                        <div className="py-6 px-8 rounded-lg bg-white">
                            <h1 className="text-gray-700 font-bold text-xl mb-3 hover:text-gray-900 hover:cursor-pointer">Dermatology Specialist.</h1>
                            <p className="text-gray-700 text-justify tracking-wide">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eum, labore. Ea debitis beatae sequi deleniti.</p>
                            <button className="mt-6 py-2 px-4 primary-bg text-white font-bold rounded-lg shadow-md hover:shadow-lg transition duration-300">More info</button>
                        </div>
                    </div>
                ...
                <div>
                    <div className="bg-white relative shadow-lg hover:shadow-xl transition duration-500 rounded-lg">
                        ...
                        <div className="py-6 px-8 rounded-lg bg-white">
                            <h1 className="text-gray-700 font-bold text-xl mb-3 hover:text-gray-900 hover:cursor-pointer">Cardiothoracic surgery.</h1>
                            <p className="text-gray-700 text-justify tracking-wide">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eum, labore. Ea debitis beatae sequi deleniti.</p>
                            <button className="mt-6 py-2 px-4 primary-bg text-white font-bold rounded-lg shadow-md hover:shadow-lg transition duration-300">More info</button>
                        </div>
                    </div>
